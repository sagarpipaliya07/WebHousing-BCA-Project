...
<html>
<head>
	<title>Client Bills | Web Housing</title>
</head>
<body>
<div id="wrapper">
		    ...
		    <div class="container-fluid">
		      <!-- Breadcrumb-->
		     	<div class="row pt-2 pb-2">
		        	<div class="col-sm-9">
				    	<h4 class="page-title">Client Bills</h4>
				    	<ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-uppercase">Manage Client Bills</div>
          
             <div class="card-body">
        		    <form method="post" action="<?php echo site_url(); ?>/admin/Client_bill_master/insert_bill" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="reg_id" id="pg_reg_id">
                                <option value="-1">Select Client Name</option>
                                <?php
                                  if (isset($reg_datas)) 
                                  {
                                    foreach ($reg_datas as $reg) 
                                    {
                                ?>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="landlord_id" id="landlord_id">
                                ...
                                <?php
                                  if (isset($landlord_datas)) 
                                  {
                                    foreach ($landlord_datas as $owner) 
                                    {
                                ?>
                                <option value="<?php echo $owner->landlord_id; ?>"><?php echo $owner->landlord_name; ?></option>
                                <?php
                                    }
                                  }
                                ?>
                        ...
                        <div class="col-md-6 col-12">
                          <div class="form-group">
                            <label>PG no</label>
                            <input type="text" name="pg_id" id="pg_id" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="bill_status" id="bill_status" class="form-control" readonly>
                          </div>
                        </div>
                      </div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td><input type="text" name="pg_booking_date" id="pg_booking_date" class="form-control" readonly></td>
                  ...
                  <table class="table table-bordered" id="tableEx">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url(); ?>/admin/client_bill?id=<?php echo $key->bill_id; ?>" class="btn btn-outline-primary">View</a>
                        </td>
                      </tr>
                      <?php
                          }
