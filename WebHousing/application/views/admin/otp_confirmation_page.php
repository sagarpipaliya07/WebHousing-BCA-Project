	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 animated fadeIn slower">
				<form class="login100-form" method="post" action="<?php echo site_url(); ?>/Otp_matching/conform_otp">
					...
					<p class="login100-form-title text-uppercase" style="color: rgb(0,128,236);text-transform: uppercase;">
						O<span style="color: rgb(0,0,0);font-size: 25px;">TP</span> 
						C<span style="color: rgb(0,0,0);font-size: 25px;">onformation</span>
					</p>
					<?php  
					...
					<?php
					}elseif (form_error('otp')) 
					{	
					?>
						<div class="alert alert-danger alert-dismissible mt-3" role="alert">
						   	<button type="button" class="close" data-dismiss="alert"><i class="fas fa-times-circle"></i></button>
							<div class="alert-message">
								<span><strong><?php echo form_error('otp'); ?></strong></span>
							</div>
						 </div>
					<?php
					}
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button type="submit" name="confirm_otp" id="confirm_otp" value="otp" class="login100-form-btn">Confirm OTP</button>
						</div>
					</div>
					<br>
					<div class="text-center p-t-115">
						<span class="txt1 text-center">GET BACK TO FORGET PASSWORD PAGE?</span>
						<a class="txt2 text-center" href="<?php echo site_url(); ?>/Forget_pwd">Click Here</a>
					</div>
				</form>
			</div>
		</div>
